...
function init(hideDefaultCursor = false, applyStyle = true) {
  ...
  if (mouse.applyStyle) $.globalContainer.append($.svg);
...
function _bindEvents() {
  const globalContainer = INode.getElement("#js-global-container");
...
function addMousemoveActions(_callback) {
  // 追加
  mousemoveActions.add(_callback);
}

function removeMousemoveActions(_callback) {
  //　削除
